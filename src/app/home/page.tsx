            ...
            <div className="grid lg:grid-cols-2 items-center gap-10">
              <div className="">
                <h2 className="md:text-4xl text-3xl font-semibold mb-6">
                  Un mejor camino para optimizar tu negocio
                </h2>
                <p>
                  Descubre cómo <b>ZenomyAI</b> revoluciona tu empresa con herramientas impulsadas por inteligencia artificial.
                  Automatiza procesos, mejora la toma de decisiones y alcanza un rendimiento excepcional.
                </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                ...
                <div className="text-center bg-white hover:shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] transition-all rounded-xl p-6">
                  ...
                  <h3 className="text-base font-semibold mt-6 mb-2">Seguridad</h3>
                  <a
                    href="javascript:void(0);"
                    className="text-blue-600 font-bold inline-block hover:underline"
                  >
                ...
                <div className="text-center bg-white hover:shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] transition-all rounded-xl p-6">
                  ...
                  <h3 className="text-base font-semibold mt-6 mb-2">Soporte</h3>
                  <a
                    href="javascript:void(0);"
                    className="text-blue-600 font-bold inline-block hover:underline"
                  >
                ...
                <div className="text-center bg-white hover:shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] transition-all rounded-xl p-6">
                  ...
                  <h3 className="text-base font-semibold mt-6 mb-2">Rendimiento</h3>
                  <a
                    href="javascript:void(0);"
                    className="text-blue-600 font-bold inline-block hover:underline"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-16">
              <div className="cursor-pointer rounded overflow-hidden group">
                <div>
                  ...
                  <h3 className="text-xl font-semibold group-hover:text-blue-500 transition-all">Trucos para maximizar tu productividad diaria
                  </h3>
                  <div className="mt-4">
                  <Image
...
/>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  />
                  <p className="text-xs">POR FELIPE CASTRO</p>
                </div>
              </div>
              <div className="cursor-pointer rounded overflow-hidden group">
                <div>
                  ...
                  <h3 className="text-xl font-semibold group-hover:text-blue-500 transition-all">
                    Tendencias y predicciones en inteligencia artificial
                  </h3>
                  <div className="mt-4">
                    <Image
              ...
              <div className="cursor-pointer rounded overflow-hidden group">
                <div>
                  ...
                  <h3 className="text-xl font-semibold group-hover:text-blue-500 transition-all">
                    Trucos para maximizar tu productividad diaria
                  </h3>
                  <div className="mt-4">
                    <Image
          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="divide-y">
              <div>
                ...
                >
                  <span className="mr-4">
                    ¿Qué hace ZenomyAI por mi negocio?
                ...
                <div className="pb-6">
                  <p>
                    ZenomyAI automatiza tareas, optimiza procesos y proporciona análisis basados en inteligencia artificial
                    para mejorar tu productividad y toma de decisiones.
              ...
              <div>
                ...
                >
                  <span className="mr-4">
                    ¿Qué planes de suscripción ofrecen?
                  </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-3.5 fill-current ml-auto shrink-0"
              ...
              <div>
                <button
                  ...
                  className="w-full text-base text-left font-semibold py-6 flex items-center"
                >
                  <span className="mr-4">¿Cómo puedo registrarme en ZenomyAI?
                  </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-3.5 fill-current ml-auto shrink-0"
              ...
              <div>
                ...
                >
                  <span className="mr-4">
                    ¿Puedo probar ZenomyAI antes de suscribirme?
                  </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-3.5 fill-current ml-auto shrink-0"
